...
public class MakePaymentImpl implements PaymentIntrfc {
	...
	public String makePayment(String makePaymentJson) {
		 ...
		 * 
		 * JSONObject jso = new JSONObject(makePaymentJson); Payment payment = new
		 * Payment();
		 * 
		 ...
		 * 
		 * payments.add(payment); return "Payemnt of Rs" + payment.getPaymentFee() +
		 * " was made succefully for course" + payment.getCourseId();
		 */
		return "";
	}
