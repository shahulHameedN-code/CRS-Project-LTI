 ...
 * 
 */
package com.lt.Admin.controller;
...
import com.lt.Admin.service.AdminService;
import com.lt.Admin.service.AdminServiceImpl;
...
public class AdminRestController {
	...
	/*
	 * @RequestMapping(path = "/generateReportCard/{studentId}", method =
	 * RequestMethod.GET) public ResponseEntity<String>
	 * generateReportCard(@PathVariable("studentId") String studentId) throws
	 * StudentReportCardNotFoundException { JSONObject result =
	 * adminService.generateReportCard(studentId); return
